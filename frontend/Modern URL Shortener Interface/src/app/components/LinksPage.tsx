      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-8 overflow-auto">
          ...
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-gray-900">Bitly Links</h1>
          ...
          <div className="space-y-4 mb-8">
            {mockLinks.map((link) => (
              <Card 
                key={link.id} 
                className="p-6 bg-white rounded-lg border border-gray-200 hover:border-gray-300 transition-colors cursor-pointer"
